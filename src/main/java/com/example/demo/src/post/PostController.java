...
public class PostController {
    ...
    public BaseResponse<PostPostingRes> createPost(@RequestBody @Valid PostPostingReq postPostingReq) {
    ...
    public BaseResponse<String> updatePost(@RequestBody @Valid PatchPostingReq patchPostingReq,
    ...
    public BaseResponse<List<GetAllPostingRes>> getAllPosts(@RequestBody @Valid GetAllPostingReq getAllPostingReq){
