...
public class SshTunnelingInitializer {
    ...
    @NotNull private String passphrase;
    ...
    public Integer buildSshConnection() {
        ...
        try {
            ...
            jSch.addIdentity(privateKey, passphrase);  // 개인키
            session = (Session) jSch.getSession(user, remoteJumpHost, sshPort);  // 세션 설정
            ...
            // 로컬 pc의 남는 포트 하나와 원격 접속한 pc의 db 포트 연결
